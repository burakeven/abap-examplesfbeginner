...
*I_SAVE = 'U' --> User-spesific save mode
*I_SAVE = 'A' --> Standard and user-specific save mode
  "*************************"

*gs_variant-variant = p_vari. "Burada sistemden tanimladigimiz /burak2'i ezerek calistirdigimizda gelecek olan save'i direkt olarak /burak yapmis oldum.
  "Ilk cumle yeterliligini yitirdi, artik daha dinamik bir yapimiz var, p_vari geldi.
...
*      it_filter               = gt_filter
**     IS_SEL_HIDE             =
*     I_DEFAULT               = 'X' "X olursa on ayardan etkilenir, bos olursa etkilenmez.
*     I_SAVE                  = 'X'
